...
from app.ocr_engine import run_ocr, get_average_confidence, get_ocr, ensure_uplb_reg_form_header, ensure_svcc_reg_form_labels
...
def process_registration_form():
    ...
    try:
        ...
        ocr_result = ensure_svcc_reg_form_labels(tmp_path, ocr_result, declared_school)
        avg_confidence = get_average_confidence(ocr_result)
