              ...
              <div className="row g-4">
                ...
                <div className="col-md-4">
                  <div className="summary-card">
                    ...
                    <p className="text-muted mb-0">
                      Available to backfill right now
                    </p>
                  </div>
                </div>
              ...
              <div className="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                ...
                <div className="d-flex gap-2">
                  ...
                  >
                    {promotingAll
                      ? "Promoting..."
                      : "Promote All Available"}
                  </button>
                </div>
              </div>

              <div className="verifier-waitlist-notice">
                <div className="verifier-waitlist-notice-icon">
                  !
                </div>

                <div className="verifier-waitlist-notice-body">
                  <strong className="verifier-waitlist-notice-title">
                    Waitlist Notice
                  </strong>
