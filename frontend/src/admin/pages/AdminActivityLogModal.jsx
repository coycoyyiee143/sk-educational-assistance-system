...
// Shows only the logged-in admin's own activity (Level 1). See AdminMasterActivityLogModal
// for the combined admin+verifier view.
function AdminActivityLogModal({ show, onClose }) {
